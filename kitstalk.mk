...
# phone
$(call inherit-product, vendor/kitstalk/config/common_full_phone.mk)

# Enhanced NFC
$(call inherit-product, vendor/kitstalk/config/nfc_enhanced.mk)

# product
PRODUCT_DEVICE := vs980
PRODUCT_BRAND := LGE
PRODUCT_NAME := kitstalk_vs980
